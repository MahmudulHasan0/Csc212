...
{ 
    ...
    bool *usedCol;
    usedCol = new bool[QUEEN+2]; //ex: QUEEN=5: 0,1,2,3,4,5,6. 0 and 6 are outofzone columns
    ...
    { 
        ...
        if (curr > QUEEN || curr == 0) //WARPING: if curr queen's position is in the forbidden zones:  QUEEN+1 or 0 , bring back the pos to 1 
            curr = 1; 
            ...
            { 
                ...
                while (needToMove == true)
                {
                    ...
                    {  
                        ...
                        curr = poppedQueen; //to use the push_Queen function
                        push_Queen(queenPos, usedCol, N, prev, curr);
                        needToMove = false;
                    }
                }
