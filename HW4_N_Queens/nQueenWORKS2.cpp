...
{ 
    ...
    { 
        ...
        if (curr > QUEEN){curr = 1; } //WARPING: if curr queen's position is QUEEN+1, bring back the pos to 1 
        if (curr == 0){curr = 1;}   //WARPING: if the curr pos is in the 0 zone, bring it to 1.
